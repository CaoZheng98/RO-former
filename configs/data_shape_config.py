...
class DataShapeConfig:
    past_len = 24  # Length of formerly known runoff sequence
    pred_len = 12  # Length of runoff sequence to be predicted
    ...
    data_shape_info = f"{src_len}_{past_len}+{pred_len}[{src_size}+{tgt_size}]"
