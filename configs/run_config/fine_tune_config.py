...
class FineTuneConfig(FineTuneLearningConfig):
    ...
    pre_saving_message = "Informer_NAR_[64-4-4-256-0.1]@daymet673_1980~1995#1995~2000#2000~2014@22_15+7[5+1]@NSELoss_n200_bs512_lr0.001_warm_up@seedNone"  # TODO
    used_model = "Informer"  # TODO
